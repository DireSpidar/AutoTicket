...
- `pyperclip` (Python clipboard library)
...
1. Clone this repo:
   ...
   ```
   git clone --branch test-python https://github.com/DireSpidar/AutoTicket.git
   ```
...
**Option 3** opens the `Templates` folder in your file manager so you can add, edit, or remove templates without leaving the script.
